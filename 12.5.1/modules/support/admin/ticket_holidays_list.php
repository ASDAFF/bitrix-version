...
$arHeaders = array(
	...
	array("id"=>"SLA",			"content"=>GetMessage("SUP_SLA"),			"sort"=>"NAME",			"default"=>true),
...
{    
	...
	$arActions[] = array("ICON"=>"delete", "TEXT"=>GetMessage("SUP_DELETE_ALT"), "ACTION"=>"if(confirm('" . GetMessage('BLB_DELETE_CONF') . "')) ".$lAdmin->ActionDoGroup($f_ID, "delete"));
...
?>
	...
	<tr>
		...
		<td>
		<select id="filter_open_time" size="1" name="filter_open_time">
		<option value=""></option>';
		<?
	...
	<tr>
		...
		<?
			...
			while($arR = $ar->Fetch())
			{
				echo InputType("checkbox", "filter_sla_id[]", $arR["ID"], $filter_sla_id) . " " . htmlspecialcharsbx($arR["NAME"]) . "<br>";
			}
		?>
		</td>
	</tr>
