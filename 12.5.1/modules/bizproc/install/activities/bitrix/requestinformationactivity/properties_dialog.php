...
<tr id="ria_pd_list_form">
	<td colspan="2">
		<table width="100%" border="0" cellpadding="2" cellspacing="2">
			...
			<tr>
				<td align="right"><?= GetMessage("BPSFA_PD_SET_STATUS_MESSAGE") ?>:</td>
				<td>
			...
			<tr>
				<td align="right"><?= GetMessage("BPSFA_PD_STATUS_MESSAGE") ?>:</td>
...
<tr id="ria_pd_edit_form">
	<td colspan="2">
		...
		<tr id="id_tr_pbria_options" style="display:none">
			<td align="right" width="40%" valign="top" id="id_td_fri_options_promt"><?= GetMessage("BPSFA_PD_F_VLIST") ?>:</td>
			<td width="60%" id="id_td_fri_options">
