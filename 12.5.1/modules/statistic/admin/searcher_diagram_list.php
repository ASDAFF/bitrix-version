	...
	<tr>
		...
		<table border="0" cellspacing="2" cellpadding="0" class="legend">
			...
			<tr>
				...
				<td nowrap class="number">(<a title="<?echo GetMessage("STAT_VIEW_SEARCHER_HITS")?>" href="/bitrix/admin/hit_searcher_list.php?lang=<?=LANGUAGE_ID?>&find_searcher_id=<?=$id?>&find_date1=<?echo $arFilter["DATE1_PERIOD"]?>&find_date2=<?echo $arFilter["DATE2_PERIOD"]?>&set_filter=Y"><?=$sector["COUNTER"]?></a>)</td>
