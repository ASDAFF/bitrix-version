...
$MESS["MAIN_DUMP_HEADER_MSG"] = "To move the site back-up archive to another server, copy the restore script <a href='#EXPORT#'>restore.php</a> and the archive file to the document root of the new server. Then, type in your browser: <b>&lt;site name&gt;/restore.php</b>.";
...
$MESS["MAIN_DUMP_SHED_ENABLE"] = "Run backup process using agents at the specified time";
