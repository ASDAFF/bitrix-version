...
class CControllerGroup
{
	...
	function GetGroupSettings($group_id)
	{
	...
	function RunCommand($group_id, $php_script, $arParameters = Array())
	{
		global $DB;
		$group_id = IntVal($group_id);
	...
	function UpdateCounters($group_id)
	{
	...
	function SetGroupSettings($group_id)
	{
		CControllerGroup::RunCommand($group_id, 'SET_SETTINGS');
	}

	function SiteUpdate($group_id)
	{
