...
<?if($arLog):?>
	...
	<tr valign="top">
		...
		<td nowrap width="100%"><a target="_blank" href="controller_member_edit.php?ID=<?echo $arLog["CONTROLLER_MEMBER_ID"]?>"><?echo $arLog["CONTROLLER_MEMBER_NAME"].' ['.$arLog["CONTROLLER_MEMBER_ID"].']'?></a></td>
	</tr>
	<tr valign="top">
	...
	<?if($arLog["USER_ID"] > 0):?>
		<tr valign="top">
			...
			<td nowrap width="100%"><a target="_blank" href="/bitrix/admin/user_edit.php?ID=<?echo $arLog["USER_ID"]?>&amp;lang=<?echo LANGUAGE_ID?>"><?echo $arLog["USER_NAME"].' '.$arLog["USER_LAST_NAME"].' ('.$arLog["USER_LOGIN"].')'?></a></td>
		</tr>
	<?endif;?>
	<tr valign="top">
