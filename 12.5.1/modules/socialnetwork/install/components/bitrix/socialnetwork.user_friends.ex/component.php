	...
	else
	{
		...
		else
		{
			...
			if ($dbFriends)
			{
				...
				$arResult["NAV_STRING"] = $dbFriends->GetPageNavStringEx($navComponentObject, GetMessage("SONET_UFE_FRIENDS_NAV"), "", false);
			}
			...
			if (!IsModuleInstalled("im"))
			{
				...
				if ($dbBan)
				{
					...
					$arResult["NAV_STRING"] = $dbBan->GetPageNavStringEx($navComponentObject, GetMessage("SONET_UFE_BAN_NAV"), "", false);
				}
			}
		}
	}
