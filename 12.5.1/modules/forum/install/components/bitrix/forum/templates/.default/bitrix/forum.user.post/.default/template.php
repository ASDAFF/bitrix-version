...
<div class="forum-header-box">
	<div class="forum-header-title">
		<span><?if ($arTopic["STATE"] != "Y"){?><span class="forum-header-title-closed">[ <span><?=GetMessage("F_CLOSED")?></span>]</span> <?}
		?><?=trim($arTopic["TITLE"])?><?if (strlen($arTopic["DESCRIPTION"])>0){?>, <?=trim($arTopic["DESCRIPTION"])?><?}?></span>
	</div>
</div>
<div class="forum-block-container">
	<div class="forum-block-outer">
