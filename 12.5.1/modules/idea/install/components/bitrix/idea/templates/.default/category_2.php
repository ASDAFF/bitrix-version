        ...
        <?if($arParams["DISABLE_RSS"] != "Y"):?>
            <?$APPLICATION->IncludeComponent(
                ...
                Array(
                    ...
                    "PATH_TO_RSS"		=> CComponentEngine::MakePathFromTemplate($arResult["PATH_TO_RSS_CATEGORY"], array("category" => ToLower($CategoryCode))),
                    "BLOG_URL"			=> $arResult["VARIABLES"]["blog"],
                ),
                $component 
            );
...
if($arResult["SET_TITLE"] == "Y")
    $APPLICATION->SetTitle(GetMessage("IDEA_CATEGORY_2_PAGE_TITLE").': '.$arCategoryList[$CategoryCode]["NAME"]);
?>