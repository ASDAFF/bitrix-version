...
//Search
if(!in_array($this->__page, array('post_edit', 'post', 'user', 'user_subscribe')))
{
    ob_start();
...
//Can Add category
if($USER->IsAuthorized() && $arParams["IBLOCK_CATOGORIES"]>0 && CIBlock::GetPermission($arParams["IBLOCK_CATOGORIES"], $USER->GetID())>="W")
{
    $arButtons = CIBlock::GetPanelButtons(
            $arParams["IBLOCK_CATOGORIES"],
            0,
            0,
            array(
                "SESSID"=>false
