...
<?
//Prepare Filter
$CategoryCode = ToUpper($arResult["VARIABLES"]["category_1"]);
...
<div class="idea-managment-content">
    ...
    <?$this->SetViewTarget("idea_filter", 100)?>
        ...
        <?$APPLICATION->IncludeComponent(
                ...
                "",
                Array(
                    "PATH_TO_CATEGORY_WITH_STATUS" => $arResult["PATH_TO_CATEGORY_1_STATUS"],
                    "PATH_TO_CATEGORY" => $arResult["PATH_TO_CATEGORY_1"],
                    "SELECTED_STATUS" => $StatusCode,
                    "CATEGORIES" => array("CATEGORY_1" => $CategoryCode),
                    "SET_NAV_CHAIN" => $arParams["SET_NAV_CHAIN"],
                ),
                $component
        );
...
if($arParams["SET_NAV_CHAIN"] == "Y")
{
    ...
    if(isset($arCategoryList[$CategoryCode])) 
        $APPLICATION->AddChainItem($arCategoryList[$CategoryCode]["NAME"], str_replace("#category_1#", $arResult["VARIABLES"]["category_1"], $arResult["PATH_TO_CATEGORY_1"]));
}
//Set Title
if($arResult["SET_TITLE"] == "Y")
    $APPLICATION->SetTitle(GetMessage("IDEA_CATEGORY_1_STATUS_PAGE_TITLE").': '.$arCategoryList[$CategoryCode]["NAME"]);
?>