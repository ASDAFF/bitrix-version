...
if(CModule::IncludeModule("fileman"))
{
	...
	function CustomizeLightEditorForIdea()
	{
		?>
		<script>
		...
		window.LHEDailogs['BlogImage'] = function(pObj)
		{
			var str = 
				...
				'<input type="hidden" value="Y" name="do_upload"/>' +
                                ...
                                '<input type="hidden" value="GET_ADD_FORM" name="ACTION"/>' +
				'</form>'+
				'</td>' +
		...
		{
			oIdeaLHELight.SaveContent();
			if (document.forms.REPLIER_LIGHT)
				document.forms.REPLIER_LIGHT.submit();
		};

		document.forms.REPLIER_LIGHT.onsubmit = function()
		{
			oIdeaLHELight.SaveContent();
		};
		</script>
	...
	AddEventHandler("fileman", "OnIncludeLightEditorScript", "CustomizeLightEditorForIdea");
