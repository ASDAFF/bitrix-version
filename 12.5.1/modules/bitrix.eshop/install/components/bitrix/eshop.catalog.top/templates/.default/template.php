...
<?foreach($arResult["ITEMS"] as $key => $arItem):
	if(is_array($arItem))
	{
		...
		?><li class="itembg R2D2" itemscope itemtype = "http://schema.org/Product">
			...
			<?endif?>
			<?if ($bPicture):?>
				<table style="width:200px !important;height:180px !important;"><tr><td class="tac vam" style="width: 200px !important;height:180px !important;"><a class="link" href="<?=$arItem["DETAIL_PAGE_URL"]?>"><img class="item_img" itemprop="image" src="<?=$arItem["PREVIEW_IMG"]["SRC"]?>" width="<?=$arItem["PREVIEW_IMG"]["WIDTH"]?>" height="<?=$arElement["PREVIEW_IMG"]["HEIGHT"]?>" alt="<?=$arElement["NAME"]?>" /></a></td></tr></table>
			<?else:?>
