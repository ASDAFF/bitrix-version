...
?>
	<a href="<?=$arResult["AUTH_URL"]?>" class="signin" onclick="var ModalName = $('#login'); CentriredModalWindow(ModalName);OpenModalWindow(ModalName);return false;"><?=GetMessage("AUTH_LOGIN")?></a>
<?
