	...
	function InitStep()
	{
		...
		$wizard->SetDefaultVars(
			Array(
				...
				"shopFacebook" => COption::GetOptionString("eshop", "shopFacebook", GetMessage("WIZ_SHOP_FACEBOOK_DEF"), $siteID),
				"shopTwitter" => COption::GetOptionString("eshop", "shopTwitter", GetMessage("WIZ_SHOP_TWITTER_DEF"), $siteID),
				"shopVk" => COption::GetOptionString("eshop", "shopVk", GetMessage("WIZ_SHOP_VK_DEF"), $siteID),
				"shopGooglePlus" => COption::GetOptionString("eshop", "shopGooglePlus", GetMessage("WIZ_SHOP_GOOGLE_PLUS_DEF"), $siteID),
...
class CatalogSettings extends CWizardStep
{
	...
	function ShowStep()
	{
			...
			<div class="wizard-input-form-block">
				...
				<div class="wizard-catalog-form">
					<div class="wizard-catalog-form-item">
						...
						.' <p>'.GetMessage("WIZ_CATALOG_FILTER_DESCR").'</p>
					</div>
					<div class="wizard-catalog-form-item">
						...
						.' <p>'.GetMessage("WIZ_CATALOG_COMPARE_DESCR").'</p>
					</div>
					<div class="wizard-catalog-form-item">
		...
		$this->content .= '
			<div class="wizard-input-form-block">
				<div class="wizard-catalog-title">'.GetMessage("WIZ_CATALOG_DETAIL_DESCR").'</div>
				<div>
					<div class="wizard-catalog-form-item">
						'. $this->ShowRadioField("catalogDetailDescr", "list", (array("id" => "catalog-detail-list")))
						.'<label for="catalog-detail-list">'.GetMessage("WIZ_CATALOG_DETAIL_DESCR_LIST").'</label>'
						.'<p>'.GetMessage("WIZ_CATALOG_DETAIL_DESCR_LIST_DESCR").'</p>
					</div>
					<div class="wizard-catalog-form-item">
						'. $this->ShowRadioField("catalogDetailDescr", "tabs", (array("id" => "catalog-detail-tabs")))
						.'<label for="catalog-detail-tabs">'.GetMessage("WIZ_CATALOG_DETAIL_DESCR_TABS").'</label>'
						.'<p>'.GetMessage("WIZ_CATALOG_DETAIL_DESCR_TABS_DESCR").'</p>
					</div>
				</div>
			</div>';
		$this->content .= '
			<div class="wizard-input-form-block">
				<div class="wizard-catalog-title">'.GetMessage("WIZ_CATALOG_DETAIL_SKU").'</div>
				<div>
					<div class="wizard-catalog-form-item">
						...
						.'<p>'.GetMessage("WIZ_CATALOG_DETAIL_SKU_SELECT_DESCR").'</p>
					</div>
					<div class="wizard-catalog-form-item">
						...
						.'<p>'.GetMessage("WIZ_CATALOG_DETAIL_SKU_LIST_DESCR").'</p>
					</div>
				</div>
			</div>';
		...
		$this->content .= '
			<div class="wizard-input-form-block">
				<div class="wizard-catalog-title">'.GetMessage("WIZ_CATALOG_USE_IDEA").'</div>
				<div>
					<div class="wizard-catalog-form-item">
						'.$this->ShowCheckboxField("useIdea", "Y", array("id" => "use-idea"))
						.'<label for="use-idea">'.GetMessage("WIZ_CATALOG_IDEA").'</label>
					</div>
				</div>
			</div>';
