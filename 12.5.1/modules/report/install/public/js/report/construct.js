...
function addSelectColumn(checkBox, calc, alias, num, grouping, grouping_subtotal)
{
	...
	var groupingCheckbox = BX.findChild(
		BX.findChild(newCol, {tag: 'span', class: 'reports-grouping-checkbox'}),
	...
	var groupingSubtotalCheckbox = BX.findChild(
		BX.findChild(newCol, {tag: 'span', class: 'reports-grouping-subtotal-checkbox'}),
		{tag: 'input', attr: {type: 'checkbox'}}
	);
	...
	var calcCheckBoxContainer = BX.findChild(newCol, {tag:'span', class:'reports-add-col-checkbox'}, true);
	...
	if (GLOBAL_BX_REPORT_USING_CHARTS)
	{
		...
		if (chartSelectsContainer)
		{
			chartSelects = BX.findChildren(
				...
				{tag: 'select', class: 'report-chart-select-col'},
				true
			);
...
function getFullColumnTitle(columnContainer)
{
    ...
    else
    {
	    ...
	    var calcCheckboxContainer = BX.findChild(
		    columnContainer, {tag: 'span', class: 'reports-add-col-checkbox'}, true
	    );
...
function parseSelectColumnType(columnContainer)
{
	...
	calcCheckbox = BX.findChild(columnContainer, {class: 'reports-checkbox', attr:{type:'checkbox'}}, true);
