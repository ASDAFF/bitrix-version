...
<?$tabControl->BeginNextTab();?>
	...
	?>
	<tr>
		<td colspan="2" style="background:white; padding: 15px;"><font style="font-family:Courier New, Arial, Helvetica, sans-serif; font-size:12px; color: #000000; text-decoration:none;"><?=preg_replace("'(^|\r\n)[\s]*([A-Za-z]*(&gt;)+)([^\r\n]+)'e", "_ConvReplies('\\2', '\\4')", TxtToHTML($dbr_arr["BODY"]))?></td>
	</tr>
	<?
