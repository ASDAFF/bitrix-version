    ...
    <?$this->SetViewTarget("idea_filter", 100)?>
        <?$APPLICATION->IncludeComponent(
                ...
                Array(
                    ...
                    "PATH_TO_RSS"		=> CComponentEngine::MakePathFromTemplate($arResult["PATH_TO_RSS_STATUS"], array("status_code" => ToLower($StatusCode))),
                    "BLOG_URL"			=> $arResult["VARIABLES"]["blog"],
                ),
                $component 
        );
...
if($arResult["SET_TITLE"] == "Y")
    $APPLICATION->SetTitle(GetMessage("IDEA_CATEGORY_0_STATUS_PAGE_TITLE"));
?>