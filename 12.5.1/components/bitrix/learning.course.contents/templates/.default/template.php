...
<script type="text/javascript" 
	src="/bitrix/components/bitrix/player/mediaplayer/flvscript.js<?php
		echo (strpos($_SERVER["HTTP_USER_AGENT"], "Opera") !== false
			? '':'?v='.filemtime($_SERVER['DOCUMENT_ROOT'].'/bitrix/components/bitrix/player/mediaplayer/flvscript.js'));
?>"></script>
