...
$catParams->iItemsCount = $dbList->SelectedRowsCount();
$catParams->bIsRed = 'N';
$catParams->createLinkFromTemplate();
...
$dbCatLessRes = CIBlockElement::GetList(Array(), $arElementFilter, false, false, array("ID"));

$catParams->sName = GetMessage("WIKI_CATEGORY_NOCAT");
$catParams->sTitle = GetMessage("WIKI_CATEGORY_NOCAT_TITLE");
$catParams->iItemsCount = $dbCatLessRes->SelectedRowsCount();
$catParams->bIsRed = 'N';
$catParams->createLinkFromTemplate();
