...
if (!defined('BX_YMAP_SCRIPT_LOADED'))
{
	...
	$arResult['MAPS_SCRIPT_URL'] = $scheme.'://api-maps.yandex.ru/'.$arParams['YANDEX_VERSION'].'/?onload=init_'.$arParams['MAP_ID'].'&load=package.full&mode=release&lang='.$arParams['LOCALE'].'&wizard=bitrix';
