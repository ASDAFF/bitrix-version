...
class CComponentParamsManager
{
	...
	public static function GetComponentProperties($name = '', $template = '', $siteTemplate = '', $currentValues = array())
	{
		...
		{
			$showTemplateName = ($template["TEMPLATE"] !== '' && $arSiteTemplates[$template["TEMPLATE"]] <> '') ? 				$arSiteTemplates[$template["TEMPLATE"]] : GetMessage("PAR_MAN_DEF_TEMPLATE");
			$arTemplates[$k]['DISPLAY_NAME'] = $template['NAME'].' ('.$showTemplateName.')';
		}
