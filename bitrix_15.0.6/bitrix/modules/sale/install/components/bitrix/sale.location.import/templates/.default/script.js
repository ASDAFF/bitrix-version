BX.locationImport = function(opts, nf){

	this.parentConstruct(BX.locationImport, opts);
	...
	this.handleInitStack(nf, BX.locationImport, opts);
};
BX.extend(BX.locationImport, BX.ui.widget);

BX.merge(BX.locationImport.prototype, {
	...
	init: function(){
		...
		//this.pushFuncStack('buildUpDOM', BX.locationImport);
		this.pushFuncStack('bindEvents', BX.locationImport);
	},
