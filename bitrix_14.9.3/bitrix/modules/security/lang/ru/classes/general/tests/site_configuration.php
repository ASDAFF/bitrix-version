...
$MESS["SECURITY_SITE_CHECKER_REDIRECT_OFF_DETAIL"] = <<<'html'
Редирект на произвольный стороний ресурс может служить подспорьем для множества атак, защита редиректов исключает эту возможность (при использовании стандартного API)
html;
...
$MESS["SECURITY_SITE_CHECKER_DANGER_EXTENSIONS_RECOMMENDATION"] = <<<'html'
Вы всегда можете изменить список расширений исполняемых файлов в настройках сайта: <a href="/bitrix/admin/settings.php?mid=fileman" target="_blank">Управление структурой</a>
html;
$MESS["SECURITY_SITE_CHECKER_DANGER_EXTENSIONS_ADDITIONAL"] = <<<'html'
Текущие: #ACTUAL#<br>
...
$MESS["SECURITY_SITE_CHECKER_MODULES_VERSION_ARRITIONAL"] = <<<'html'
Модули для которых доступны обновления:<br>#MODULES#
html;
?>