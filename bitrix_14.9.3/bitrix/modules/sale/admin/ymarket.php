	...
	foreach($arTabs as $arTab)
	{
		...
		?>
			...
			<tr>
				...
				<td width="60%"><?=makeSelectorFromPaySystems("YMSETTINGS[".htmlspecialcharsbx($arTab["SITE_ID"])."][PAY_SYSTEMS][YANDEX]", $siteSetts["PAY_SYSTEMS"]["YANDEX"], $siteSetts["PERSON_TYPE"])?></td>
			</tr>
			<tr>
