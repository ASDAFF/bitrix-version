		...
		foreach ($arControls as &$arOneControl)
		{
			...
			switch ($arOneControl['ID'])
			{
				case 'CondBsktCntGroup':
					$arOne['control'] = array(
						Loc::getMessage('BT_SALE_COND_GROUP_BASKET_NUMBER_PREFIX'),
				...
				case 'CondBsktAmtGroup':
					$arOne['control'] = array(
						Loc::getMessage('BT_SALE_COND_GROUP_BASKET_AMOUNT_PREFIX'),
						$arOneControl['ATOMS']['All'],
						$arOneControl['ATOMS']['Logic'],
						$arOneControl['ATOMS']['Value']
					);
				...
				case 'CondBsktProductGroup':
					$arOne['control'] = array(
						Loc::getMessage('BT_SALE_COND_GROUP_PRODUCT_PREFIX'),
						$arOneControl['ATOMS']['Found'],
						Loc::getMessage('BT_SALE_COND_GROUP_PRODUCT_DESCR'),
						$arOneControl['ATOMS']['All']
					);
					break;
				case 'CondBsktRowGroup':
					$arOne['control'] = array(
						Loc::getMessage('BT_SALE_COND_GROUP_BASKET_ROW_PREFIX'),
						$arOneControl['ATOMS']['All'],
						$arOneControl['ATOMS']['Logic'],
						$arOneControl['ATOMS']['Value']
					);
	...
	public static function GetControls($strControlID = false)
	{
		$arControlList = array(
			...
			'CondBsktFldSumm' => array(
				...
				'PREFIX' => Loc::getMessage('BT_MOD_SALE_COND_BASKET_ROW_SUMM_PREFIX'),
			...
			'CondBsktFldPrice' => array(
				...
				'PREFIX' => Loc::getMessage('BT_MOD_SALE_COND_BASKET_ROW_PRICE_PREFIX'),
				'LOGIC' => static::GetLogic(
					array(
						BT_COND_LOGIC_EQ,
						BT_COND_LOGIC_NOT_EQ,
			...
			'CondBsktFldQuantity' => array(
				...
				'PREFIX' => Loc::getMessage('BT_MOD_SALE_COND_BASKET_ROW_QUANTITY_PREFIX'),
				'LOGIC' => static::GetLogic(
					array(
						BT_COND_LOGIC_EQ,
						BT_COND_LOGIC_NOT_EQ,
			...
			'CondBsktFldWeight' => array(
				...
				'PREFIX' => Loc::getMessage('BT_MOD_SALE_COND_BASKET_ROW_WEIGHT_PREFIX'),
				'LOGIC' => static::GetLogic(
					array(
						BT_COND_LOGIC_EQ,
						BT_COND_LOGIC_NOT_EQ,
