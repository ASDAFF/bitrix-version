...
$MESS["CLO_STORAGE_GOOGLE_EDIT_HELP"] = "Для начала использования необходимо активировать <a href=\"http://code.google.com/intl/ru-RU/apis/storage/docs/signup.html\">Google Storage for Developers</a>. Далее в <a href=\"https://code.google.com/apis/console#:storage\">консоли управления API Google</a> необходимо активировать совместимый доступ (Legacy Access) и включить биллинг.";
?>