...
if ($_SERVER["REQUEST_METHOD"] == "POST" && $CURRENCY_RIGHT=="W" && isset($_POST['Update']) && !empty($_POST['Update']) && check_bitrix_sessid())
{
	if (isset($_POST['BASE']) && $_POST['BASE'] == 'N')
	{
		$arFields = array(
...
$defaultLangValues = array(
	...
	'FORMAT_STRING' => '#',
	'DEC_POINT' => '.',
	'THOUSANDS_SEP' => CCurrencyLang::SEP_SPACE,
	'DECIMALS' => 2,
	'THOUSANDS_VARIANT' => '',
	'HIDE_ZERO' => 'Y'
);
