	...
	if ($arParams['AUTOSAVE'])
		...
		$APPLICATION->IncludeComponent("bitrix:main.post.form", "",
			Array(
				...
				"BUTTONS" => array_intersect(
					array("UploadFile", "CreateLink", "InputVideo", "Quote", "MentionUser"),
				...
				"UPLOAD_FILE" => (isset($arResult["USER_FIELDS"]["UF_FORUM_MESSAGE_DOC"]) || $arParams["ALLOW_UPLOAD"]=="N" ? false :
					array(
						"INPUT_NAME" => 'FILE_NEW',
						"INPUT_VALUE" => array(),
				...
				"HTML_BEFORE_TEXTAREA" => $APPLICATION->GetViewContent(implode('_', array($tplID, 'EDIT', 'BEFORE'))),
